ON_DAED['3D'].AnimacaoPiramideIdle = function (scene, autoTransicao, notUseKeys) {
    ...
    $('#load-modal').data('loadAudio')('sounds/pao-de-acucar-curvas-de-nivel.mp3', function (audio) {
        ...
        $('#load-modal').data('loadOBJMTL')('paoDeAcucarCamadas', 'models/pao_de_acucar-final.obj', 'models/pao_de_acucar-final.mtl', function (object) {
...
//                obj.rotation.z += incrementoAnimacao;
    ...
    $('#load-modal').data('loadAudio')('sounds/logomarca-observatorio-nacional.mp3', function (audio) {
        ...
        $('#load-modal').data('loadOBJMTL')('logo_ON', 'models/logo_ON.obj', 'models/logo_ON.mtl', function (object) {
...
//        });
    ...
    $('#load-modal').data('loadAudio')('sounds/emblema-do-observatorio-nacional.mp3', function (audio) {
        ...
        $('#load-modal').data('loadOBJMTL')('logo_ON_antigo', 'models/logo_antigo-final.obj', 'models/logo_antigo-final.mtl', function (object) {
...
//
    ...
    $('#load-modal').data('loadAudio')('sounds/voyager-1.mp3', function (audio) {
        ...
        $('#load-modal').data('loadOBJMTL')('voyager', 'models/voyager/Voyager_17.obj', 'models/voyager/Voyager_17.mtl', function (object) {
...
//        });
    ...
    loadPlaneta("CARTA MAGNÉTICA - INTENSIDADE", "imgs/texturas/terra/carta-magnetica-intensidade.png", "sounds/carta-magnetica-intensidade.mp3", function (planeta, obj) {
        obj.s = 0.9;
    });

    loadPlaneta("CARTA MAGNÉTICA - DECLINAÇÃO", "imgs/texturas/terra/carta-magnetica-declinacao.png", "sounds/carta-magnetica-declinacao.mp3", function (planeta, obj) {
        obj.s = 0.9;
    });

    loadPlaneta("CARTA MAGNÉTICA - INCLINAÇÃO", "imgs/texturas/terra/carta-magnetica-inclinacao.png", "sounds/carta-magnetica-inclinacao.mp3", function (planeta, obj) {
        obj.s = 0.9;
    });

    loadPlaneta("CARTA MAGNÉTICA - VARIAÇÃO SECULAR DE INTENSIDADE", "imgs/texturas/terra/carta-magnetica-variacao-intensidade.png", "sounds/carta-magnetica-variacao-intensidade.mp3", function (planeta, obj) {
        obj.s = 0.75;
    });

    loadPlaneta("CARTA MAGNÉTICA - VARIAÇÃO SECULAR DE DECLINAÇÃO", "imgs/texturas/terra/carta-magnetica-variacao-declinacao.png", "sounds/carta-magnetica-variacao-declinacao.mp3", function (planeta, obj) {
        obj.s = 0.75;
    });

    loadPlaneta("CARTA MAGNÉTICA - VARIAÇÃO SECULAR DE INCLINAÇÃO", "imgs/texturas/terra/carta-magnetica-variacao-inclinacao.png", "sounds/carta-magnetica-variacao-inclinacao.mp3", function (planeta, obj) {
        obj.s = 0.75;
    });

    loadPlaneta("PLANETA MERCÚRIO", "imgs/texturas/planetas/mercury.jpg", "sounds/mercurio.mp3");

    loadPlaneta("PLANETA VÊNUS", "imgs/texturas/planetas/venus-cloud.jpg", "sounds/venus.mp3");

    loadPlaneta("PLANETA TERRA", "imgs/texturas/terra/map.jpg", "sounds/terra.mp3");

    loadPlaneta("PLANETA MARTE", "imgs/texturas/planetas/mars.jpg", "sounds/marte.mp3");

    loadPlaneta("PLANETA JÚPITER", "imgs/texturas/planetas/jupiter.jpg", "sounds/jupiter.mp3");

    loadPlaneta("PLANETA SATURNO", "imgs/texturas/planetas/saturn.jpg", "sounds/saturno.mp3", function (saturn) {
        var rings = new THREE.Mesh(new THREE.PlaneBufferGeometry(160, 160), new THREE.MeshBasicMaterial({
            side: THREE.DoubleSide,
            transparent: true,
            map: THREE.ImageUtils.loadTexture("imgs/texturas/planetas/saturn-rings.png")
        }));
    ...
    loadPlaneta("PLANETA URANO", "imgs/texturas/planetas/uranus.jpg", "sounds/urano.mp3");

    loadPlaneta("PLANETA NETUNO", "imgs/texturas/planetas/neptune.jpg", "sounds/netuno.mp3");

    loadPlaneta("SATÉLITE LUA", "imgs/texturas/lua/lua-new.jpg", "sounds/lua.mp3");
...
// Meteoro
    $('#load-modal').data('loadAudio')("sounds/cometa67p.mp3", function (audio) {
        $('#load-modal').data('loadOBJMTL')('voyager', 'models/meteoro/meteoro.obj', 'models/meteoro/meteoro.mtl', function (object) {
