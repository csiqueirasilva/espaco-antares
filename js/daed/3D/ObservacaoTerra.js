...
//        ThreeHelper.createLabel("J2000", objectLabelEquadorCelesteJ2000, camera);
    ...
    var sol = ON_DAED["3D"].criarSol(75, scene);
...
//        luz.shadowCameraVisible = true;
    ...
    ON_DAED["3D"].register(wrapperTerra, precessaoTerra, function () {
        ...
        if (diff > 0) {
            ...
            if (nutacao) {
                ...
                if (lastObliq !== null && lastObliq.parent !== undefined) {
    ...
    function criarObliquidadeEcliptica(obliquidade) {
        ...
        if (labelObliquidadeEcliptica.parent !== undefined) {
    ...
    o.coordenadasHorizontais = function (longitude, latitude, azimute, altura) {
        ...
        ON_DAED["3D"].createTextLabel(ON_DAED["3D"].TEXT_LABEL.NORTE, norte);
        ...
        ON_DAED["3D"].createTextLabel(ON_DAED["3D"].TEXT_LABEL.SUL, sul);
        ...
        ON_DAED["3D"].createTextLabel(ON_DAED["3D"].TEXT_LABEL.OESTE, oeste);
        ...
        ON_DAED["3D"].createTextLabel(ON_DAED["3D"].TEXT_LABEL.LESTE, leste);
